...
module.exports = (config) => {
  ...
  /**
   * In a rest based service, services are represented by routes
   *A service can be charactrised by a  name, version, port it can be found in
   *  : ==> contains the route dynamic parameter
   * service should be able to register itself, delete and be found find
   */
